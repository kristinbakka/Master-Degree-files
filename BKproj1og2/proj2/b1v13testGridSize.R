...
#funValues[,1]
a=isingModel(rows=rows1,cols=cols1,runsG=runsG1,beta=beta1,
                  u=a0, colsum = TRUE)

#all ones (2)
a1=matrix(1, nrow = rows1, ncol = cols1)
#funValues[,2]=
b=isingModel(rows=rows1,cols=cols1,runsG=runsG1,beta=beta1,
                  u=a1, colsum = TRUE)
...
#funValues[,3]
c=isingModel(rows=rows1,cols=cols1,runsG=runsG1,beta=beta1,
                  u=aR, colsum = TRUE)
#checkerboard (4)
if(rows1%%2==1){
  #odd number of rows
...
#funValues[,4]
d=isingModel(rows=rows1,cols=cols1,runsG=runsG1,beta=beta1,
                  u=aC, colsum = TRUE)
